...
public class ExceptionApiResponse {
    ...
    private String type = "/error/sin-categoria/error-generico";
    ...
    private String instance = "/error/sin-categoria/error-generico/error-interno";

    public ExceptionApiResponse(String title, String code, String detail) {
        super();
        this.title = title;
        this.code = code;
        this.detail = detail;
